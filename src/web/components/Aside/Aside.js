          ...
          <TabPane tabId="1">
            ...
            <div className="callout callout-warning m-0 py-3">
              <div className="avatar float-right">
                <img src={'../../../public/core/img/avatars/7.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com"/>
              </div>
            ...
            <div className="callout callout-primary m-0 py-3">
              ...
              <div className="avatars-stack mt-2">
                ...
                <div className="avatar avatar-xs">
                  <img src={'../../../public/core/img/avatars/8.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                </div>
              </div>
            </div>
            <hr className="mx-3 my-0"/>
